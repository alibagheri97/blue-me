...
CATALOG_CATEGORIES = [
    ...
    ("بسته‌بندی", "ظروف و ملزومات مصرفی سفارش بیرون‌بر", "#f97316"),
]
...
CATALOG_ITEMS = [
    ...
    ("SHW-037", "ظرف آلومینیومی", "بسته‌بندی", "عدد"),
    ("SHW-038", "خلال دندان", "بسته‌بندی", "عدد"),
    ("SHW-039", "دستمال کاغذی", "بسته‌بندی", "عدد"),
    ("SHW-040", "پاکت بیرون‌بر", "بسته‌بندی", "عدد"),
    ("SHW-041", "قاشق و چنگال یک‌بارمصرف", "بسته‌بندی", "عدد"),
]
