...
import { AlertTriangle, ArrowDownRight, ArrowUpRight, BarChart3, Boxes, CircleDollarSign, Clock3, Lightbulb, PackageSearch, ReceiptText, Sparkles, Target } from "lucide-react";
...
export default function ReportsPage() {
  ...
  return (
    <div className="page-stack reports-page">
      <header className="page-heading"><div><span className="eyebrow">هوش تجاری</span><h1>مرکز آمار و تحلیل</h1><p>فروش، سود، تقاضا، مشتری و موجودی؛ تبدیل داده‌های واقعی به تصمیم بهتر.</p></div><select className="period-select" value={days} onChange={(e) => setDays(Number(e.target.value))}><option value={7}>۷ روز اخیر</option><option value={30}>۳۰ روز اخیر</option><option value={90}>۹۰ روز اخیر</option><option value={365}>۱۲ ماه اخیر</option></select></header>
