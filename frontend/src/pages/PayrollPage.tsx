...
import { PointSplit } from "../components/PointSplit";
...
export default function PayrollPage() {
  ...
  const totals = useMemo(() => (calculations.data || []).reduce((acc, item) => ({
    ...
    positivePoints: acc.positivePoints + item.positive_points,
    negativePoints: acc.negativePoints + item.negative_points,
    minutes: acc.minutes + item.worked_minutes,
  }), { payable: 0, positivePoints: 0, negativePoints: 0, minutes: 0 }), [calculations.data]);
  ...
  return <div className="page-stack payroll-page">
    ...
    <section className="payroll-summary-grid">
      ...
      <article><span className="violet"><Sparkles /></span><div><small>امتیازهای مثبت و منفی تیم</small><PointSplit positive={totals.positivePoints} negative={totals.negativePoints} /></div></article>
