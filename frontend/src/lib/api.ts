...
const errorTranslations: Record<string, string> = {
  ...
  "A reason is required for system waste": "دلیل اتلاف را با حداقل ۳ نویسه وارد کنید.",
  "System waste cannot be assigned to a customer or staff member": "اتلاف سیستم حساب مستقل دارد و به مشتری یا پرسنل متصل نمی‌شود.",
  "Temporary attendance has no checklist or points": "ورود موقت چک‌لیست و امتیاز ندارد.",
  "Select both start and end dates": "تاریخ شروع و پایان را انتخاب کنید.",
  "Report range must be between 1 and 365 days": "بازه گزارش باید از ۱ تا ۳۶۵ روز باشد.",
